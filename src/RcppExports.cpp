...
RcppExport SEXP _wCI_rCIBootCUDA(SEXP prcimatSEXP, SEXP pRSEXP, SEXP pnSEXP, SEXP pxtiesSEXP, SEXP pytiesSEXP, SEXP pseedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type prcimat(prcimatSEXP);
    ...
    Rcpp::traits::input_parameter< SEXP >::type pyties(pytiesSEXP);
    Rcpp::traits::input_parameter< SEXP >::type pseed(pseedSEXP);
    rcpp_result_gen = Rcpp::wrap(rCIBootCUDA(prcimat, pR, pn, pxties, pyties, pseed));
    return rcpp_result_gen;
END_RCPP
}
// newPCI
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_wCI_rCIBootCUDA", (DL_FUNC) &_wCI_rCIBootCUDA, 6},
