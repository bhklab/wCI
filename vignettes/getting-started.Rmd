...
the high level noise in drug response measurements. Here we introduce the wCI package implementing a modification of the concordance index (CI), called the 
